...
from ctapipe.containers import ReconstructedEnergyContainer, ReconstructedGeometryContainer
...
from .template_network_interpolator import TemplateNetworkInterpolator
...
from ctapipe.reco import HillasGeometryReconstructor, ReconstructionProperty
from ctapipe.reco.reconstructor import InvalidWidthException, TooFewTelescopesException
...
class ImPACTReconstructor(HillasGeometryReconstructor):
    ...
    def set_up_templates(self):
        """Set up the templates for the ImPACT reconstruction."""
        template_sort_dict = {}
